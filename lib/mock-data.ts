...
const CLAIMS: Claim[] = [
  ...
  },
  {
    ...
    insured: { name: "Mr. Ravindra Khandelwal" },
    status: "settlement",
    statusDetail: "Repair & completion",
    statusDetailTone: "positive",
    updatedAt: "1 day ago",
    stage: 3,
    totalStages: 4,
    stageLabel: "Repair & completion",
    alert: null,
    approvedAmount: 38420,
    payoutMode: "cashless",
    payoutMessage: "Insurer will pay you directly",
    stages: [
      {
        id: "s1",
        title: "Estimate Submitted",
        state: "done",
        timestamp: "24 May 12:00 PM",
      },
      {
        id: "s2",
      ...
      },
      {
        ...
        state: "current",
        detail: "1 document needed now to proceed",
        detailTone: "danger",
      },
      {
        id: "s4",
        title: "Delivery & discharge",
        state: "future",
        detail: "Unlocks after invoice is verified",
        detailTone: "muted",
        pill: "UP NEXT",
      },
    ],
